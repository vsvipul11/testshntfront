...
Command: npx gltfjsx@6.2.16 ./public/Mal.glb 
*/

import React, { useRef, useEffect } from 'react'
import { useGLTF, useAnimations } from '@react-three/drei'

export function Mal(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/Mal.glb')
  ...
  // useEffect(() => {
  //   if (group.current) {
  //     group.current.rotation.y = -Math.PI/2; // Rotate the group by 180 degrees (pi radians)
  //   }
  // }, []);
